...
<div class="container mt-4">
    <div class="row">
        ...
        <div class="col-md-9">
                ...
                <form action="editmembership.php" method="POST">
  <div class="form-group">
  <input type="hidden" name="id" value="<?php echo $id?>">
    <label for="type">Membership Type:</label>
    <input type="text" class="form-control" value="<?php echo $type?>" id="type" name="type" required>
  </div>
  <div class="form-group">
    <label for="duration">Duration(Months):</label>
    <input type="text" class="form-control" value="<?php echo $duration?>" id="duration" name="duration" required>
  </div>
  <div class="form-group">
    <label for="amount">Amount:</label>
    <input type="text" class="form-control" value="<?php echo $amount?>" id="amount" name="amount" required>
  </div>
