...
<div class="container mt-4">
  ...
  <div class="form-group">
    ...
    <div class="form-group">
    Instructor:&nbsp;<input type="checkbox" id="myCheckbox" name="myCheckbox" <?php if($ins == 'on') echo 'checked'; ?>>
     </div>
     <div class="form-group">
     <input type="text" class="form-control" id="desc" value="<?php echo $desc?>" name="desc" placeholder="Description about instructor">
        </div>
     <div class="form-group">
